...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/06 15:21:54 by yena              #+#    #+#             */
/*   Updated: 2023/12/06 15:36:15 by yena             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param list 정렬될 리스트
 * @param element 정렬할 원소
 * @param left 이진 탐색 범위의 최소값
 * @param right 이진 탐색 범위의 최대값
 */
...
std::list<int> sortPairList(std::list<int> list,
  ...
  if (list.size() % 2 == 1) {
    ...
    binarySearchList(sorted_list, *last_it, 0, sorted_list.size() - 1);
  }
  return sorted_list;
}
